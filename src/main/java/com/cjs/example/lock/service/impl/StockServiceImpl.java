...
public class StockServiceImpl implements StockService {
    ...
    @Override
    public boolean addProductCount(Integer productId,Integer productCount) {
        if (productCount <= 0) {
            return false;
        }
        HashOperations<String, String, String> hashOperations = stringRedisTemplate.opsForHash();
        hashOperations.put(RedisKeyPrefixConstant.STOCK, String.valueOf(productId), String.valueOf(productCount));
        return true;
    }
